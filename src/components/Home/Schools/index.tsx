...
const Schools = () => {
  ...
  const schools: School[] = [
    {
      href: 'https://platzi.com/escuela/datos/',
    ...
    {
      href: 'https://platzi.com/escuela/ciberseguridad/',
    ...
    {
      href: 'https://platzi.com/escuela/liderazgo-management/',
    ...
    {
      href: 'https://platzi.com/escuela/ingles/',
    ...
    {
      href: 'https://platzi.com/escuela/web/',
    ...
    {
      href: 'https://platzi.com/escuela/marketing/',
    ...
    {
      href: 'https://platzi.com/escuela/producto/',
      title: 'Producto',
      color1: '#9D82DD',
      color2: '#9D82DD',
    ...
    {
      href: 'https://platzi.com/escuela/audiovisual/',
    ...
    {
      href: 'https://platzi.com/escuela/transformacion-digital-business/',
    ...
    {
      href: 'https://platzi.com/escuela/negocios/',
      title: 'Negocios',
      color1: '#CD931D',
      color2: '#CD931D',
    ...
    {
      href: 'https://platzi.com/escuela/recursos-humanos/',
    ...
    {
      href: 'https://platzi.com/escuela/startups/',
      title: 'Startups',
      color1: '#559D91',
      color2: '#559D91',
    ...
    {
      href: 'https://platzi.com/escuela/finanzas/',
    ...
    {
      href: 'https://platzi.com/escuela/diversidad/',
    ...
    {
      href: 'https://platzi.com/escuela/devops-cloud/',
    ...
    {
      href: 'https://platzi.com/escuela/programacion-software/',
    ...
    {
      href: 'https://platzi.com/escuela/blockchain/',
    ...
    {
      href: 'https://platzi.com/escuela/diseno/',
